...
This article provides information on how rate limiting is applied to REST and WebSocket API calls. To check the current rate limits, see the table [REST and WebSocket limits.](#rest-and-websocket-limits)
