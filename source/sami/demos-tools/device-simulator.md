...
To use the commands in this article, [**download the Device Simulator.**](https://github.com/samsungsamiio/samsungsami.io/blob/master/source/sami/downloads/device-simulator20141212.zip?raw=true) <br /><br />Java JDK v8 update 25 or higher is required.
{:.info}
